...
\shorttitle{Guitar Cabinet Reproduction with Spherical Array Signals and HRIRs}
...
\twocolumn[
    ...
    \begin{onecolabstract}
        A guitar loudspeaker cabinet simulation system with modern binaural rendering method is proposed.
        The system reproduces the binaural sound image of the sound field produced by a guitar speaker cabinet, which gives immersive guitar playing experience through convolution with the pre-amplified guitar signal from the player.
        The method was achieved by employing directional impulse responses obtained from a 80-channel spherical microphone array and HRIR dataset, and integrating them in the spherical harmonic domain.
        This work hopes to provide an outlook of the immersive guitar playing experience.
    \end{onecolabstract}
]
